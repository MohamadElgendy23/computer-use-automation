...
│   ├── discovery_run.log
│   ├── replay_success.log
│   ├── replay_business_outcome.log
│   ├── replay_failure.log
│   └── replay_failure_step_5.png
├── .env
├── .gitignore
└── README.md
```
...
From the `computer-use-system` directory, create and activate a virtual environment:
...
`evidence/replay_business_outcome.log`
...
`evidence/replay_failure.log`

and:

`evidence/replay_failure_step_5.png`
...
The `evidence/` directory contains evidence from the system's discovery and replay runs.
...
`artifacts/step_1.png`
`artifacts/step_2.png`
`artifacts/step_3.png`
`artifacts/step_4.png`
`artifacts/step_5.png`
